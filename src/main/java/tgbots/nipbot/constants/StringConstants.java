...
//    лист callback из массива выше, для удобства дальнейшей работы с ним
    ...
    public static String mentionToVol1(String dogCandidates, String catCandidates) {
        return String.format("""
                ...
                Информация о пользователе представлена в следуюшем виде: номер id чата, @ник пользователя в телеграм, имя пользователя, фамилия пользователя, номер телефона.
    ...
    public static String mentionToVol2(String dogCandidates, String catCandidates) {
        return String.format("""
                ...
                - если было принято решение о продлении испытательного срока: "номер id чата LONG кол-во дней продления", например "478512469 LONG 14",
                продление испытательного срока возможно либо на 14, либо на 30 дней.
